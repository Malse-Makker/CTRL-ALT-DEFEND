...
static func defs() -> Dictionary:
	return {
		"noti":  {"name": "The Notification", "ability": "Plain and fast. No tricks.",
			"hp": 4.0, "speed": 105.0, "reward": 0.8, "damage": 1, "radius": 11.0, "color": Color(0.9, 0.72, 0.3)},
		"hulp":  {"name": "The Question", "ability": "Tougher basic enemy.",
			"hp": 12.0, "speed": 80.0, "reward": 1.6, "damage": 2, "radius": 15.0, "color": Color(0.85, 0.4, 0.5)},
		"story": {"name": "User Story", "ability": "Heavy basic enemy.",
			"hp": 26.0, "speed": 70.0, "reward": 2.8, "damage": 4, "radius": 18.0, "color": Color(0.8, 0.45, 0.7)},
		"tank":  {"name": "The Old Guard", "ability": "Shielded: break the shield first. Burst it down. That archive is legally required to be kept — the shredder won't touch it.",
			"hp": 46.0, "speed": 50.0, "reward": 4.5, "damage": 8, "radius": 19.0, "color": Color(0.55, 0.55, 0.6), "shield": 30.0, "zone_mult": 0.0},
		"nudge": {"name": "The Nudge", "ability": "Very fast swarm. Needs area damage or slows.",
			"hp": 3.0, "speed": 190.0, "reward": 0.35, "damage": 1, "radius": 8.0, "color": Color(0.95, 0.85, 0.3)},
		"thread": {"name": "The Thread", "ability": "Arrives as one big printed pile. Paper — the shredder eats it.",
			"hp": 2.0, "speed": 88.0, "reward": 0.3, "damage": 1, "radius": 9.0, "color": Color(0.88, 0.87, 0.82), "zone_mult": 1.6},
		"change":{"name": "The Change", "ability": "Splits into two Tasks when killed.",
			"hp": 16.0, "speed": 80.0, "reward": 2.0, "damage": 3, "radius": 16.0, "color": Color(0.5, 0.7, 0.55), "split_count": 2, "split_type": "task"},
		"task":  {"name": "Task", "ability": "Small and quick. Spawned by The Change.",
			"hp": 4.0, "speed": 135.0, "reward": 0.4, "damage": 1, "radius": 9.0, "color": Color(0.5, 0.75, 0.6)},
		"micro": {"name": "The Micro-manager", "ability": "Speeds up the more damage it takes.",
			"hp": 20.0, "speed": 60.0, "reward": 2.5, "damage": 4, "radius": 15.0, "color": Color(0.9, 0.55, 0.2), "rage": 2.5},
		"kletskous": {"name": "The Chatterbox", "ability": "Silences nearby towers while passing. Shrugs off crowd control — only Noise Cancelling (Headphones lvl 3) shuts him up.",
		...
		"feedback": {"name": "Feedback", "ability": "Spawned by the boss.",
		...
		# tegen de printer.
		"printer": {"name": "The Printer", "ability": "Jams every few seconds and spits out Error messages. Kill it early or drown in them.",
			"hp": 34.0, "speed": 44.0, "reward": 4.0, "damage": 6, "radius": 19.0, "color": Color(0.62, 0.66, 0.72),
			"spawner": 3.4, "spawn_type": "error", "spawn_count": 2},
		"error": {"name": "Error Message", "ability": "Have you tried turning it off and on again? Spawned by The Printer.",
			"hp": 5.0, "speed": 118.0, "reward": 0.4, "damage": 1, "radius": 9.0, "color": Color(0.85, 0.75, 0.35)},
		"phish": {"name": "Suspicious Link", "ability": "Invisible until a Shredder zone reveals it.",
			"hp": 10.0, "speed": 100.0, "reward": 2.0, "damage": 3, "radius": 12.0, "color": Color(0.5, 0.85, 0.7), "invisible": true},
		"board": {"name": "The Board Member", "ability": "Immune to Office Artillery. Grind it down.",
			"hp": 40.0, "speed": 60.0, "reward": 3.5, "damage": 8, "radius": 18.0, "color": Color(0.4, 0.45, 0.55), "immune_to": "ceo"},
		"cold":  {"name": "The Cold Caller", "ability": "Immune to Auto-Reply. Needs burst.",
			"hp": 24.0, "speed": 92.0, "reward": 3.0, "damage": 4, "radius": 15.0, "color": Color(0.7, 0.5, 0.35), "immune_to": "auto"},
		"caller": {"name": "The Phone Caller", "ability": "On a loud call. Single-target towers fire at him FIRST — and he can take it, so the rest slips by.",
			"hp": 34.0, "speed": 86.0, "reward": 3.5, "damage": 5, "radius": 16.0, "color": Color(0.45, 0.7, 0.85), "aggro": true},
		"update": {"name": "System Update", "ability": "Installing... briefly invulnerable while it updates, then keeps coming. Burst it between updates.",

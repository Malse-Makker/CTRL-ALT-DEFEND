...
const WAVES := {
	...
	6: [
		...
		"change:6@1.10 + steering:1@2.00 + nudge:38@0.12",
		"kletskous:3@1.60 + micro:5@1.40 + phish:5@1.00",
		"printer:3@1.60 + tank:4@1.40 + story:5@1.10",
		"steering:1@2.00 + change:7@1.00 + cold:6@1.00",
	...
	10: [
		...
		"steering:1@2.00 + micro:6@1.30 + change:8@1.00",
